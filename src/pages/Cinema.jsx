  ...
  return (
    <section className="col-span-6 px-8">
        ...
        <div className="flex flex-col gap-2">
            {cinemas.map((cinema)=>(
                <Link to={`/cinema/${cinema.name}/${today}`} key={cinema.id} className="flex items-center gap-2 justify-between cursor-pointer bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 px-2">
                  <div className="flex items-center gap-2">
                    <div className="w-12 h-12 flex items-center"><img src="https://a0.muscache.com/im/pictures/miso/Hosting-730884644046569848/original/23cba0d9-2fcd-4720-a41d-f66092e17a00.jpeg?im_w=1200" alt="" /></div>
                    <h2>{cinema.name}</h2>
                  </div>
